...
The Services are intended for adult participants and authorized representatives of teams, leagues, associations, referees, and businesses. You must be able to form a binding contract to use the Services.
...
Some features are role based (player, referee, team manager, league administrator, association administrator, business). If you act on behalf of a team, league, association, or business, you represent that you have authority to do so.

## 4. Services Overview

The Services may include:
- Registration and roster management
- Payments, dues collection, and transaction tracking
- Digital identity, eligibility, and conduct related workflows
- Communication features for participants and administrators
- Marketplace listings, sponsor activations, and offers
...
### 6.1 Payments
Certain Services require payment. Payments may be processed by third party processors and may be subject to their terms.
...
If you create listings or offers, you are responsible for:
...
You may stop using the Services at any time. We may suspend or terminate access if we reasonably believe you violated these Terms or pose a risk to the Services or other users.

## 10. Disclaimers

The Services are provided on an "as is" and "as available" basis. We do not guarantee uninterrupted operation or that the Services will be error free.
